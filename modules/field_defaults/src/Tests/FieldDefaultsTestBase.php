...
class FieldDefaultsTestBase extends WebTestBase {
   ...
   * @var array
   */
  public static $modules = array('block', 'node', 'field_ui', 'field_defaults');
   ...
   *
   */
  protected function setDefaultValues($fieldName, $field_type = 'boolean', $values = array(), $contentType = 'page') {
