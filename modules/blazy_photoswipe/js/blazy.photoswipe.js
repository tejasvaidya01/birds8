...
(function (Drupal, drupalSettings, PhotoSwipe, PhotoSwipeUI_Default, _db) {
  ...
  Drupal.theme.blazyPhotoSwipeMedia = function (settings) {
    ...
    var elm = item.el;
    var alt = elm.querySelector('img') !== null ? elm.querySelector('img').getAttribute('alt') : '';
...
}(Drupal, drupalSettings, PhotoSwipe, PhotoSwipeUI_Default, dBlazy));
